...
class AppTypography {
  ...
  static TextStyle get displaySmall =>
      _font.copyWith(fontSize: 36, fontWeight: FontWeight.w800);
  ...
  static TextStyle get headlineMedium =>
      _font.copyWith(fontSize: 28, fontWeight: FontWeight.w700);

  static TextStyle get headlineSmall =>
      _font.copyWith(fontSize: 24, fontWeight: FontWeight.w600);

  // Titles - For cards and list items
  static TextStyle get titleLarge =>
      _font.copyWith(fontSize: 22, fontWeight: FontWeight.w600);

  static TextStyle get titleMedium =>
      _font.copyWith(fontSize: 16, fontWeight: FontWeight.w600);

  static TextStyle get titleSmall =>
      _font.copyWith(fontSize: 14, fontWeight: FontWeight.w600);

  // Body - For general text
  static TextStyle get bodyLarge =>
      _font.copyWith(fontSize: 16, fontWeight: FontWeight.w500, height: 1.5);

  static TextStyle get bodyMedium =>
      _font.copyWith(fontSize: 14, fontWeight: FontWeight.w500, height: 1.45);

  static TextStyle get bodySmall =>
      _font.copyWith(fontSize: 12, fontWeight: FontWeight.w500, height: 1.4);

  // Labels - For small UI elements
  static TextStyle get labelLarge =>
      _font.copyWith(fontSize: 14, fontWeight: FontWeight.w700);

  static TextStyle get labelMedium =>
      _font.copyWith(fontSize: 12, fontWeight: FontWeight.w700);

  static TextStyle get labelSmall =>
      _font.copyWith(fontSize: 11, fontWeight: FontWeight.w700);
